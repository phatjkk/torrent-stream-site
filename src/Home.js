              ...
              <tbody>
                {AdSearchedArray.map((e, i) => (
                  <tr key={i}>
                    <td>{i}</td>
                    <Link to="/Watch">
                      <button onClick={()=>handleChooseMovie(e.Magnet,e.Name)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
                        {e.Name}
                      </button>
                      </Link>
                    <td>{e.Size}</td>
